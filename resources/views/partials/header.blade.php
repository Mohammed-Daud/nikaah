    ...
    <div class="content-wrap d-flex space-bet align-center">
        <div class="left-content">
            <div class="logo-wrap">
                ...
                <noscript>
                    <img width="143" height="47" src="images/logo.png" alt="Nikaah">
                </noscript>
                </a>
                <a class="navbar-brand high-res" href="index.php">
                <img width="143" height="47" src="images/logo.png" alt="Nikaah" data-lazy-src="images/logo.png" data-ll-status="loaded" class="entered lazyloaded">
                <noscript><img width="143" height="47" src="images/logo.png" alt="Nikaah"></noscript>
                </a>
            </div>
            <div class="ham-icon">
                <span></span>
